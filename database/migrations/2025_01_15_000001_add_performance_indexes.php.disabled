...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('gpx_points', function (Blueprint $table) {
            ...
            // Index composite pour les requêtes géographiques (remplace l'index spatial)
            $table->index(['latitude', 'longitude'], 'idx_gpx_points_location');
        });
        ...
        Schema::table('sortie_gpx_points', function (Blueprint $table) {
            ...
            // Index composite pour les requêtes géographiques (remplace l'index spatial)
            $table->index(['latitude', 'longitude'], 'idx_sortie_gpx_points_location');
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('gpx_points', function (Blueprint $table) {
            ...
            $table->dropIndex('idx_gpx_points_location');
        });

        Schema::table('sortie_gpx_points', function (Blueprint $table) {
            $table->dropIndex('idx_sortie_gpx_points_trace');
            $table->dropIndex('idx_sortie_gpx_points_location');
        });
